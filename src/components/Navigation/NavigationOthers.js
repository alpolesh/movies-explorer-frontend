      ...
      {isHamburgerMenu 
        ...
        : 
          <div className="header__navigation">
            <Link to={routes.movies} className="header__link-container"><p className="header__link header__link_type_bold">Фильмы</p></Link>
            <Link to={routes.savedMovies} className="header__link-container"><p className="header__link">Сохранённые фильмы</p></Link>
            <Link to={routes.profile} className="header__link-container">
